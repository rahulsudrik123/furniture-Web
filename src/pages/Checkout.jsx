                ...
                <div className="card-body">
                  ...
                  {cart.items.map((item) => (
                    <div key={item.title} className="d-flex justify-content-between mb-2">
                      ...
                      <span>{item.subTotal.toFixed(2)} RS</span>
                    </div>
                  ))}
                  <hr />
                  <div className="d-flex justify-content-between mb-2">
                    <p className="card-text fw-bold">Order Sub-Total : </p>
                    <span className='text-success'>{subTotal.toFixed(2)} RS</span>
                  </div>
                  <hr />
                  <div className="d-flex justify-content-between mb-2">
                    <p className="card-text fw-bold">Order Total : </p>
                    <span className='text-danger'>{totalOrder.toFixed(2)} RS</span>
                  </div>
                  ...
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="deliveryAmana">Delivery by Amana 24h: 30.00 RS</label>
                  </div>
                  <div className="form-check">
                    <input
                      type="radio"
